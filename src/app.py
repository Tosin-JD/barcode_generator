...
class BarcodeGeneratorFrame(wx.Frame):
    ...
    def on_about(self, event):
        ...
        info.SetName("Professional Barcode Generator")
        info.SetVersion("1.0")
        info.SetDescription("A comprehensive barcode generation application supporting multiple formats and batch processing.")
        info.SetWebSite("https://github.com/your-repo")
        info.AddDeveloper("Barcode Generator Team")
